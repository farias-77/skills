...
<!--
  ...
  reviewers contest one only on defect. A decision the session skipped
  is a question from the author back to the user — never his to take.
-->
...
<!-- Layer 2: one subsection per document, all ten, in writing order.
     ...
     and stays with the author. Same block format. -->
